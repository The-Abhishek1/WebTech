...
export default function Contact() {
  return (
    <div className="flex  text-white bg-indigo-950 flex-col items-center gap-7 py-10 px-5">
      ...
      <div className="p-2 hover:bg-indigo-950 hover:shadow-slate-100 hover:shadow-sm cursor-pointer rounded-md flex flex-row shadow-md shadow-blue-400 items-center self-center justify-center gap-2 bg-blue-500 text-white w-[170px]">
